...
def Novel_CNN(datanum=1024, channelnum=1):
    input_size = (datanum, channelnum)
    ...
    output1 = layers.Dense(datanum * channelnum)(flatten1)
    output1 = layers.Reshape((datanum, channelnum))(output1)
